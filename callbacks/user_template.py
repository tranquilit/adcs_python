...
# As before
from utils import NtdsCASecurityExt,search_user,validate_csr, is_directly_issued_by_cert_in_folder, _cert_has_template_oid
...
# =======================================
# 3) Certificate issuance (CES callback)
# =======================================
